...
public class DetailsMovie extends YouTubeBaseActivity {
    ...
    TextView txtTitleDetail, txtvote_average,txtdate,txtGenre,txtBudget,txtRevenue,txtOverview;
...
public void setRecyclerCast(ArrayList<Cast> cast){
    ...
    private void getDetails( String id) {
        ...
        MService mService = RetrofitClient.getInstance().getClientDetails().create(MService.class);
